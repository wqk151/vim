...
Plug 'honza/vim-snippets'  " 一些常用的代码片段"
...
" 自动补全配置
" 让Vim的补全菜单行为与一般IDE一致(参考VimTip1228), 打开无法显示YCM的提示文档
